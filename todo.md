...
- [ ] §PORTAL-PHASE-2-01: Implement parallelWorkers.ts — WorkerSpec, WorkerResult types, runParallelWorkers lifecycle primitive
- [ ] §PORTAL-PHASE-2-02: Implement aggregateWorkerResults — reads Ruflo memory, Claude aggregation, token sanitization
- [ ] §PORTAL-PHASE-2-03: Wire parallel fan-out into executeWrapperTurn (additive path, parallelSpecs parameter)
- [ ] §PORTAL-PHASE-2-04: Update architect.context.md Section 8 with parallel worker fan-out sub-section
- [ ] §PORTAL-PHASE-2-05: Write INV-P2-01 through INV-P2-10 behavioral tests (parallelWorkers.test.ts)
- [ ] §PORTAL-PHASE-2-06: Pass all validation gates (pnpm check, all contract tests, build)
- [ ] §PORTAL-PHASE-2-07: Live 3-worker fan-out verification with timing proof
- [ ] §PORTAL-PHASE-2-08: Deploy to GitHub main with commit URL and checkpoint
